...
public class Enfant extends Joueur implements Serializable{
    ...
    public Enfant(String nom,String pnom,Date DateNaissance,String mot_de_passe,ArrayList <PartieJeu> liste,int dernier_niveau){
      super.nom=nom;
      super.prénom=pnom;
  ...
  ArrayList<Question> getQuestions(String thème){
    ...
    for(int j=0;j<liste.size();j++){
     ...
     if(q  instanceof QuestionEnfant) qst.add(q);
    }
    }   
    }
     return qst;
...
public String toString() {
  return "Enfant[num=" + num + ", nom=" + nom + ", prénom=" + prénom + ", mot_de_passe=" + mot_de_passe
